    ...
    return (
      <div className='w-full h-[375px] px-12 mb-8'>
        ...
        <div className='w-full h-0.5 bg-divider1 rounded-sm'></div>
          ...
          <a onClick={() => router.push('/moreArtwork')} className='text-divider2 text-sm font-medium hover:font-semibold hover:text-purple1 cursor-pointer transition-all'>More ArtWorks</a>        
          </div>
        </div>
