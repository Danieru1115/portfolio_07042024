...
const Header = () => {
  ...
  return (
    <div className={`z-50 w-full h-16 lg:h-24 bg-white py-6 px-4 lg:px-8 flex justify-start items-center gap-6  rounded-b-xl lg:rounded-b-3xl shadow-header hover:shadow-headerHover transition-all fixed ${scrolled ? 'top-0' : ''}`}>
      <div className=' w-10 lg:w-12 h-full flex justify-center items-center' onClick={scrollToTop}>
    ...
    <defs>
      ...
      <div className='w-full h-full bg-white hidden md:flex items-center justify-end gap-6 p-2'>
